 ...
 */
$url = app_url('reset-password/' . rawurlencode($token));
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <title>Réinitialisation de mot de passe — <?= e($appName) ?></title>
</head>
            ...
            <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#FFFFFF;border-radius:16px;overflow:hidden;">
                ...
                <tr>
                    <td style="padding:32px;">
                        <h1 style="margin:0 0 12px;font-size:20px;">Réinitialisation de votre mot de passe</h1>
